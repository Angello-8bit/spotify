...
SPOTIFY_CLIENT_ID_SECRET = getenv("SPOTIFY_CLIENT_ID_SECRET")
...
def get_info_and_add(track_name):
    # grabs the song inputed by the user.
    try:
...
def get_features_cluster(track_name):
    # Gets the featutres from the user input. 
...
def get_features_nn(track_name):
    # Grabs the features for the Nearest Neighbors.
